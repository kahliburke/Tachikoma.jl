...
function load_export_prefs!()
    ...
    return EXPORT_EMBED_FONT_PREF[] = @load_preference("export_embed_font", true)
end

function save_export_prefs!(
    font_path::String, formats::Set{String}; theme_name::String="", embed_font::Bool=true
)
    ...
    @set_preferences!(
        "export_font" => font_path,
        "export_formats" => fmts_str,
        "export_theme" => theme_name,
        "export_embed_font" => embed_font
    )
end
