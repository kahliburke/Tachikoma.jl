...
**26 Themes** — 12 dark and 14 light palettes with hot-swappable switching via the **Ctrl+T** theme selector.
...
| [Themes](https://kahliburke.github.io/Tachikoma.jl/dev/styling) | 26 themes (dark + light) with hot-swap switching |
