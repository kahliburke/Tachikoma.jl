...
@testset "value: TreeView" begin
    root = T.TreeNode("root"; children=[T.TreeNode("child1"), T.TreeNode("child2")])
...
@testset "selected_node: TreeView" begin
    root = T.TreeNode(
        "root";
        children=[T.TreeNode("child1", content=[0xf1a, "content1", -3.2e-8]), T.TreeNode("child2")],
    )
    tv = T.TreeView(root; selected=2)
    @test T.value(tv) == 2
...
@testset "TreeView navigation" begin
    root = T.TreeNode(
        "root";
        children=[T.TreeNode("a"; children=[T.TreeNode("a1"), T.TreeNode("a2")]), T.TreeNode("b")],
    )
...
@testset "TreeView collapse/expand" begin
    root = T.TreeNode("root"; children=[T.TreeNode("a"; children=[T.TreeNode("a1")])])
