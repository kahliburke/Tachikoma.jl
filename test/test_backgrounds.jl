...
@testset "PhyloTree render determinism" begin
    ...
    T.render_background!(bg, buf1, area, 42; brightness=0.5, saturation=0.5, speed=1.0)
    T.render_background!(bg, buf2, area, 42; brightness=0.5, saturation=0.5, speed=1.0)
